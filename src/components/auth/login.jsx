...
import vote from "../../assets/gif/clip-voting.gif";
        ...
        <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
          ...
          <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
            ...
            >
              ...
              <p className="text-base font-medium ml-4 my-0 text-gray-700">
            ...
            <div className="w-full flex items-center justify-between py-5">
              ...
              <p className="text-base font-medium leading-4 px-2.5 text-gray-500 my-0">
                OR
              </p>
              <hr className="w-full bg-gray-400" />
            </div>
            ...
            <div className="mt-8">
              <button
                aria-label="login"
                className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-[#3A54AA] border rounded hover:bg-indigo-600 py-4 w-full"
          ...
          <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
            <div className="flex items-center">
              ...
              <h2 className="hidden sm:block text-base text-gray-100 font-bold leading-normal pl-3">
                Ecclipse
              </h2>
            </div>{" "}
            <div className="flex items-start mt-8">
              ...
              <p className="sm:text-2xl text-xl leading-7 text-[#fafafa] pl-2.5">
