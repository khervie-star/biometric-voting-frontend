        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-items-between gap-x-6 gap-y-5">
          ...
          <div className="flex flex-col justify-center items-start p-2 bg-white">
            <div className="relative">
              <img
                ...
                src="https://i.ibb.co/znBmcWV/Rectangle-37-1.png"
                alt="headphones"
              />
              <img
                className="lg:hidden"
                src="https://i.ibb.co/hBXHm0W/Rectangle-37-1.png"
                alt="headphones"
              />
          ...
          <div className="flex flex-col justify-center items-start p-2 bg-white">
            <div className="relative">
              <img
                className="hidden lg:block"
                src="https://i.ibb.co/vHj3fjr/Rectangle-37-2.png"
                alt="speaker"
              />
              <img
                className="lg:hidden"
                src="https://i.ibb.co/QbpT9td/Rectangle-37-2.png"
                alt="speaker"
              />
          ...
          <div className="flex flex-col justify-center items-start p-2 bg-white">
            <div className="relative">
              <img
                className="hidden lg:block"
                src="https://i.ibb.co/KsbPgh8/Rectangle-37-3.png"
                alt="game-controller"
              />
              <img
                className="lg:hidden"
                src="https://i.ibb.co/QrX9pRv/Rectangle-37-3.png"
                alt="game-controller"
              />
